...
<body id="main">
	...
	<%
		...
		try {
			...
			if(cln == 0) {
				...
				//session.setAttribute("rmpl",like);
				//read main post like
			%>		
				<div id="contentbox">
				글번호: <%=num %><br>
	...
	%>
	<input id="recom" type="button" onclick="location.href='likeproc.jsp?num=<%=readNum%>'" value="추천!">
	</label><br><br>	
	...
	<form action="commentproc.jsp" method="get">
		...
		<textarea name="content" id="r_comment2"></textarea>
